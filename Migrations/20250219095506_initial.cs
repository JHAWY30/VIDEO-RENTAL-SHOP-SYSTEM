...
namespace _VideoRentalShop.Migrations
{
    /// <inheritdoc />
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RentalHeaderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    CustomerId = table.Column<int>(type: "int", nullable: false),
                    RentedDate = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()"),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_RentalHeader_Movies_MovieId",
                        column: x => x.MovieId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RentalHeaderDetails", x => x.RentalDetailId);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_RentalHeaderDetails_Movies_MovieId1",
                        column: x => x.MovieId1,
                        principalTable: "Movies",
                        principalColumn: "MovieId");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RentalHeaderDetails_MovieId1",
                table: "RentalHeaderDetails",
                column: "MovieId1");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Movies_RentalHeader_RentalHeaderId",
                table: "Movies",
                column: "RentalHeaderId",
                principalTable: "RentalHeader",
                principalColumn: "RentalHeaderId");
